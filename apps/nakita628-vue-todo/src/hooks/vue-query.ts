...
/**
 * Returns Vue Query query options for GET /api
 */
...
/**
 * Generates Vue Query cache key for GET /api
 */
...
/**
 * Returns Vue Query query options for GET /api/todo
 */
...
/**
 * Generates Vue Query cache key for GET /api/todo
 */
...
/**
 * Returns Vue Query query options for GET /api/todo/{id}
 */
...
/**
 * Generates Vue Query cache key for GET /api/todo/{id}
 */
