...
type InteractionCallbackResponseType = {
  readonly interaction: z.infer<typeof InteractionResponseSchema>
  readonly resource?:
...
const NameplatePaletteSchema = z.any().readonly().openapi('NameplatePalette')
...
const OAuth2ScopesSchema = z
  .xor([
    ...
    z.literal('connections').openapi({
      title: 'CONNECTIONS',
      description: 'allows /users/@me/connections to return linked third-party accounts',
    }),
    z.literal('guilds').openapi({
      title: 'GUILDS',
      description:
        "allows /users/@me/guilds to return basic information about all of a user's guilds",
    }),
    z.literal('guilds.join').openapi({
      title: 'GUILDS_JOIN',
      description:
        'allows /guilds/{guild.id}/members/{user.id} to be used for joining users to a guild',
    }),
    z.literal('guilds.members.read').openapi({
    ...
    z.literal('rpc.screenshare.read').openapi({
    ...
    z.literal('rpc.screenshare.write').openapi({
...
const UInt32TypeSchema = z.int64().min(0n).max(4294967295n).readonly().openapi('UInt32Type')
...
const MessageActivityResponseSchema = z.object({}).readonly().openapi('MessageActivityResponse')
...
const PollLayoutTypesSchema = z.any().readonly().openapi('PollLayoutTypes')
...
type MessageResponseType = {
  readonly type: z.infer<typeof MessageTypeSchema>
  readonly content: string
  readonly mentions: readonly z.infer<typeof UserResponseSchema>[]
  readonly mention_roles: readonly z.infer<typeof SnowflakeTypeSchema>[]
  readonly attachments: readonly z.infer<typeof MessageAttachmentResponseSchema>[]
  readonly embeds: readonly z.infer<typeof MessageEmbedResponseSchema>[]
  ...
  readonly sticker_items?: readonly z.infer<typeof MessageStickerItemResponseSchema>[]
  readonly id: z.infer<typeof SnowflakeTypeSchema>
  readonly channel_id: z.infer<typeof SnowflakeTypeSchema>
  readonly author: z.infer<typeof UserResponseSchema>
  readonly pinned: boolean
  readonly mention_everyone: boolean
  readonly tts: boolean
  readonly call?: z.infer<typeof MessageCallResponseSchema>
  readonly activity?: z.infer<typeof MessageActivityResponseSchema>
  readonly application?: z.infer<typeof BasicApplicationResponseSchema>
  readonly application_id?: z.infer<typeof SnowflakeTypeSchema>
  readonly interaction?: z.infer<typeof MessageInteractionResponseSchema>
  readonly nonce?: number | string | ({ readonly [key: string]: unknown } | null)
  readonly webhook_id?: z.infer<typeof SnowflakeTypeSchema>
  readonly message_reference?: z.infer<typeof MessageReferenceResponseSchema>
  readonly thread?: z.infer<typeof ThreadResponseSchema>
  readonly mention_channels?: readonly (
    | ({ readonly [key: string]: unknown } | null)
    | z.infer<typeof MessageMentionChannelResponseSchema>
  )[]
  readonly role_subscription_data?: z.infer<typeof MessageRoleSubscriptionDataResponseSchema>
  readonly purchase_notification?: z.infer<typeof PurchaseNotificationResponseSchema>
  readonly position?: number
  readonly resolved?: z.infer<typeof ResolvedObjectsResponseSchema>
  readonly poll?: z.infer<typeof PollResponseSchema>
  ...
  readonly message_snapshots?: readonly z.infer<typeof MessageSnapshotResponseSchema>[]
  readonly reactions?: readonly z.infer<typeof MessageReactionResponseSchema>[]
  readonly referenced_message?:
    | ({ readonly [key: string]: unknown } | null)
...
type ScoreCursorType = {
  readonly type: z.infer<typeof SearchCursorTypeSchema>
  readonly score?:
    | ({ readonly [key: string]: unknown } | null)
    | z.infer<typeof ScoreCursorInnerScoreCursorSchema>
}
...
type ErrorDetailsType =
  | { readonly [key: string]: ErrorDetailsType }
  | z.infer<typeof InnerErrorsSchema>
...
const ApplicationCommandHandlerSchema = z.any().readonly().openapi('ApplicationCommandHandler')
...
const ConfettiPotionCreateRequestSchema = z
  .object({})
  .readonly()
  .openapi('ConfettiPotionCreateRequest')
...
const EntitlementOwnerTypesSchema = z.any().readonly().openapi('EntitlementOwnerTypes')
...
const QuarantineUserActionMetadataSchema = z
  .object({})
  .readonly()
  .openapi('QuarantineUserActionMetadata')
...
const EntityMetadataStageInstanceSchema = z
  .object({})
  .readonly()
  .openapi('EntityMetadataStageInstance')
...
const EntityMetadataVoiceSchema = z.object({}).readonly().openapi('EntityMetadataVoice')

const EntityMetadataVoiceResponseSchema = z
  .object({})
  .readonly()
  .openapi('EntityMetadataVoiceResponse')
...
const MLSpamTriggerMetadataResponseSchema = z
  .object({})
  .readonly()
  .openapi('MLSpamTriggerMetadataResponse')
...
const GuildFeaturesSchema = z
  .xor([
    ...
    z.literal('PREVIEW_ENABLED').openapi({
      title: 'PREVIEW_ENABLED',
      description:
        'guild can be previewed before joining via Membership Screening or the directory',
    }),
    z.literal('RAID_ALERTS_DISABLED').openapi({
    ...
    z.literal('VIP_REGIONS').openapi({
      title: 'VIP_REGIONS',
      description:
        'guild has access to set 384kbps bitrate in voice (previously VIP voice servers)',
    }),
    z.literal('WELCOME_SCREEN_ENABLED').openapi({
...
const IconEmojiResponseSchema = z.object({}).readonly().openapi('IconEmojiResponse')
...
const MLSpamTriggerMetadataSchema = z.object({}).readonly().openapi('MLSpamTriggerMetadata')
...
const TypingIndicatorResponseSchema = z.object({}).readonly().openapi('TypingIndicatorResponse')

const UnbanUserFromGuildRequestSchema = z.object({}).readonly().openapi('UnbanUserFromGuildRequest')
