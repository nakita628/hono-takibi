...
type ExtremeCompositionsType = {
  ...
  readonly deeplyNestedComposition?: (
    | (({ readonly a?: string } & { readonly b?: number }) | { readonly c?: boolean })
    | { readonly d?: number }
  ) & { readonly e?: string }
  readonly complexNot?: { readonly value?: string } & { readonly [key: string]: unknown }
  readonly conditionalChain?: { readonly [key: string]: unknown }
  readonly conflictingAllOf?: { readonly shared?: string } & { readonly shared?: string } & {
    readonly shared?: string
  }
  readonly recursiveConstrained?: {
    readonly value?: string
    readonly children?: readonly ExtremeCompositionsType[]
  }
}
