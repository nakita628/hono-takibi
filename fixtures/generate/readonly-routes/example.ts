...
const CustomFormatModelSchema = z
  .object({
    ...
    decimalValue: DecimalSchema.exactOptional(),
    jwtValue: JwtTokenSchema,
    uuidV7Value: UuidV7Schema.exactOptional(),
    base64UrlValue: Base64UrlSchema.exactOptional(),
    durationValue: IsoDurationSchema.exactOptional(),
    shortCode: ShortCodeSchema.exactOptional(),
    nullableInt32Value: NullableInt32Schema.exactOptional(),
    nullableShortCode: NullableShortCodeSchema.exactOptional(),
  })
  .openapi({
    required: [
      'int32Value',
