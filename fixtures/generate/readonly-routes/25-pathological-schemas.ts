...
type RecursiveNightmaresType = {
  readonly mutuallyRecursive?: z.infer<typeof RecursiveASchema>
  readonly constrainedRecursive?: z.infer<typeof ConstrainedTreeSchema>
  readonly recursiveInAllOf?: { readonly value?: string } & {
    readonly child?: RecursiveNightmaresType
  }
  readonly recursiveInOneOf?: string | { readonly nested?: RecursiveNightmaresType }
  readonly recursiveMap?: { readonly [key: string]: RecursiveNightmaresType }
  readonly recursiveArray?: readonly (readonly RecursiveNightmaresType[])[]
}
...
type RecursiveAType = { readonly value?: string; readonly refB?: z.infer<typeof RecursiveBSchema> }
...
type RecursiveBType = { readonly value?: number; readonly refC?: z.infer<typeof RecursiveCSchema> }

type RecursiveCType = { readonly value?: boolean; readonly refA?: z.infer<typeof RecursiveASchema> }

type ConstrainedTreeType = {
  readonly value: string
  readonly children?: readonly ConstrainedTreeType[]
  readonly parent?: ConstrainedTreeType
  readonly siblings?: readonly ConstrainedTreeType[]
}
