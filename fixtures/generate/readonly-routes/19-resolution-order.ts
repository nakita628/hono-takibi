...
type DataSchemaType = {
  ...
  readonly nested?: { readonly [key: string]: DataSchemaType }
}

type SimpleConditionType = {
  readonly field: string
  readonly operator: string
  readonly value: { readonly [key: string]: unknown }
}
...
type CompoundConditionType = {
  readonly and?: readonly z.infer<typeof ConditionSchema>[]
  readonly or?: readonly z.infer<typeof ConditionSchema>[]
  readonly not?: z.infer<typeof ConditionSchema>
}
...
const StageConfigSchema = z.record(z.string(), ConfigValueSchema).readonly().openapi('StageConfig')
