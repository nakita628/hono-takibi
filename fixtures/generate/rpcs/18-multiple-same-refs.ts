...
export async function getDocuments(
  args: { query: { author?: string; reviewer?: string; approver?: string } },
  options?: ClientRequestOptions,
) {
  return await client.documents.$get(args, options)
}
...
export async function postCompare(
  ...
  return await client.compare.$post(args, options)
}
...
export async function postWorkflows(
  ...
  return await client.workflows.$post(args, options)
}
