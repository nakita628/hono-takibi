 ...
 * POST /pathological
 */
export async function postPathological(body: {
  contradictions?: {
  ...
  ambiguous?: {
    ...
    ambiguousAnyOf?: number | number | 1 | 2 | 3 | unknown
  ...
  return await client.pathological.$post({ json: body })
}
