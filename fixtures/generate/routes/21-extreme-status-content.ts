  ...
  request: {
    body: {
      content: {
        ...
        'multipart/digest': { schema: z.object({}).optional().openapi({ type: 'object' }) },
        'multipart/parallel': { schema: z.object({}).optional().openapi({ type: 'object' }) },
        'multipart/byteranges': { schema: z.object({}).optional().openapi({ type: 'object' }) },
