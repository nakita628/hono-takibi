...
const WebhookSchema = z
  .object({
    ...
    secret: z.string().optional().openapi({ type: 'string', writeOnly: true }),
    status: z
...
const OrderStatusCallbackCallbacks = {
...
const PaymentCallbackCallbacks = {
...
const GenericWebhookCallbackCallbacks = {
  '{$request.body#/url}': {
    post: {
