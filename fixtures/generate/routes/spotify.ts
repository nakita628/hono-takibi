...
const SimplifiedTrackObjectSchema = z
  .object({
    artists: z
      .array(SimplifiedArtistObjectSchema)
      .exactOptional()
      .openapi({
        description:
...
const AudioAnalysisObjectSchema = z
  .object({
    bars: z
      .array(TimeIntervalObjectSchema)
      .exactOptional()
      .openapi({
        description:
