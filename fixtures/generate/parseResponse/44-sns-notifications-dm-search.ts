...
export async function postNotificationsMarkRead(
  ...
  return await parseResponse(client.notifications['mark-read'].$post(args, options))
}
...
export async function getNotificationsSettings(options?: ClientRequestOptions) {
  return await parseResponse(client.notifications.settings.$get(undefined, options))
}
...
export async function putNotificationsSettings(
  ...
  return await parseResponse(client.notifications.settings.$put(args, options))
}
...
export async function getDmConversations(
  ...
  return await parseResponse(client.dm.conversations.$get(args, options))
}
...
export async function postDmConversations(
  ...
  return await parseResponse(client.dm.conversations.$post(args, options))
}
...
export async function getDmConversationsConversationId(
  ...
  return await parseResponse(client.dm.conversations[':conversationId'].$get(args, options))
}
...
export async function deleteDmConversationsConversationId(
  ...
  return await parseResponse(client.dm.conversations[':conversationId'].$delete(args, options))
}
...
export async function getDmConversationsConversationIdMessages(
  ...
  return await parseResponse(
    client.dm.conversations[':conversationId'].messages.$get(args, options),
  )
}
...
export async function postDmConversationsConversationIdMessages(
  ...
  return await parseResponse(
    client.dm.conversations[':conversationId'].messages.$post(args, options),
  )
}
...
export async function postDmConversationsConversationIdRead(
  ...
  return await parseResponse(client.dm.conversations[':conversationId'].read.$post(args, options))
}
...
export async function postDmConversationsConversationIdTyping(
  ...
  return await parseResponse(client.dm.conversations[':conversationId'].typing.$post(args, options))
}
...
export async function deleteDmMessagesMessageId(
  ...
  return await parseResponse(client.dm.messages[':messageId'].$delete(args, options))
}
...
export async function postDmMessagesMessageIdReactions(
  ...
  return await parseResponse(client.dm.messages[':messageId'].reactions.$post(args, options))
}
...
export async function deleteDmMessagesMessageIdReactions(
  ...
  return await parseResponse(client.dm.messages[':messageId'].reactions.$delete(args, options))
}
...
export async function getDmUnreadCount(options?: ClientRequestOptions) {
  return await parseResponse(client.dm['unread-count'].$get(undefined, options))
}
...
export async function getSearchPosts(
  ...
  return await parseResponse(client.search.posts.$get(args, options))
}
...
export async function getSearchUsers(
  ...
  return await parseResponse(client.search.users.$get(args, options))
}
...
export async function getSearchHashtags(
  ...
  return await parseResponse(client.search.hashtags.$get(args, options))
}
...
export async function getSearchRecent(options?: ClientRequestOptions) {
  return await parseResponse(client.search.recent.$get(undefined, options))
}
...
export async function deleteSearchRecent(options?: ClientRequestOptions) {
  return await parseResponse(client.search.recent.$delete(undefined, options))
}
...
export async function getTrends(
  ...
  return await parseResponse(client.trends.$get(args, options))
}
...
export async function getTrendsLocations(options?: ClientRequestOptions) {
  return await parseResponse(client.trends.locations.$get(undefined, options))
}
...
export async function getSuggestionsUsers(
  ...
  return await parseResponse(client.suggestions.users.$get(args, options))
}
...
export async function postSuggestionsUsersUserIdHide(
  ...
  return await parseResponse(client.suggestions.users[':userId'].hide.$post(args, options))
}
...
export async function getSuggestionsTopics(options?: ClientRequestOptions) {
  return await parseResponse(client.suggestions.topics.$get(undefined, options))
}
...
export async function postTopicsTopicIdFollow(
  ...
  return await parseResponse(client.topics[':topicId'].follow.$post(args, options))
}
...
export async function deleteTopicsTopicIdFollow(
  ...
  return await parseResponse(client.topics[':topicId'].follow.$delete(args, options))
}
