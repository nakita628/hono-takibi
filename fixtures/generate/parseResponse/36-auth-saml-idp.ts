...
export async function getSamlSso(
  ...
  return await parseResponse(client.saml.sso.$get(args, options))
}
...
export async function postSamlSso(
  ...
  return await parseResponse(client.saml.sso.$post(args, options))
}
...
export async function getSamlSlo(
  ...
  return await parseResponse(client.saml.slo.$get(args, options))
}
...
export async function postSamlSlo(
  ...
  return await parseResponse(client.saml.slo.$post(args, options))
}
...
export async function postSamlAcs(
  ...
  return await parseResponse(client.saml.acs.$post(args, options))
}
...
export async function getSamlMetadata(options?: ClientRequestOptions) {
  return await parseResponse(client.saml.metadata.$get(undefined, options))
}
...
export async function getServiceProviders(
  ...
  return await parseResponse(client['service-providers'].$get(args, options))
}
...
export async function postServiceProviders(
  ...
  return await parseResponse(client['service-providers'].$post(args, options))
}
...
export async function getServiceProvidersSpId(
  ...
  return await parseResponse(client['service-providers'][':spId'].$get(args, options))
}
...
export async function putServiceProvidersSpId(
  ...
  return await parseResponse(client['service-providers'][':spId'].$put(args, options))
}
...
export async function deleteServiceProvidersSpId(
  ...
  return await parseResponse(client['service-providers'][':spId'].$delete(args, options))
}
...
export async function getServiceProvidersSpIdMetadata(
  ...
  return await parseResponse(client['service-providers'][':spId'].metadata.$get(args, options))
}
...
export async function putServiceProvidersSpIdMetadata(
  ...
  return await parseResponse(client['service-providers'][':spId'].metadata.$put(args, options))
}
...
export async function getServiceProvidersSpIdAttributes(
  ...
  return await parseResponse(client['service-providers'][':spId'].attributes.$get(args, options))
}
...
export async function putServiceProvidersSpIdAttributes(
  ...
  return await parseResponse(client['service-providers'][':spId'].attributes.$put(args, options))
}
...
export async function getAttributes(options?: ClientRequestOptions) {
  return await parseResponse(client.attributes.$get(undefined, options))
}
...
export async function getCertificates(options?: ClientRequestOptions) {
  return await parseResponse(client.certificates.$get(undefined, options))
}
...
export async function postCertificates(
  ...
  return await parseResponse(client.certificates.$post(args, options))
}
...
export async function deleteCertificatesCertId(
  ...
  return await parseResponse(client.certificates[':certId'].$delete(args, options))
}
...
export async function postCertificatesCertIdActivate(
  ...
  return await parseResponse(client.certificates[':certId'].activate.$post(args, options))
}
...
export async function getAuditLogs(
  ...
  return await parseResponse(client['audit-logs'].$get(args, options))
}
