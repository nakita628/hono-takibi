...
export async function postWebauthnRegisterOptions(
  ...
  return await parseResponse(client.webauthn.register.options.$post(args, options))
}
...
export async function postWebauthnRegisterVerify(
  ...
  return await parseResponse(client.webauthn.register.verify.$post(args, options))
}
...
export async function postWebauthnAuthenticateOptions(
  ...
  return await parseResponse(client.webauthn.authenticate.options.$post(args, options))
}
...
export async function postWebauthnAuthenticateVerify(
  ...
  return await parseResponse(client.webauthn.authenticate.verify.$post(args, options))
}
...
export async function getWebauthnCredentials(options?: ClientRequestOptions) {
  return await parseResponse(client.webauthn.credentials.$get(undefined, options))
}
...
export async function getWebauthnCredentialsCredentialId(
  ...
  return await parseResponse(client.webauthn.credentials[':credentialId'].$get(args, options))
}
...
export async function deleteWebauthnCredentialsCredentialId(
  ...
  return await parseResponse(client.webauthn.credentials[':credentialId'].$delete(args, options))
}
...
export async function patchWebauthnCredentialsCredentialId(
  ...
  return await parseResponse(client.webauthn.credentials[':credentialId'].$patch(args, options))
}
...
export async function getWebauthnSettings(options?: ClientRequestOptions) {
  return await parseResponse(client.webauthn.settings.$get(undefined, options))
}
...
export async function getWebauthnSettingsRp(options?: ClientRequestOptions) {
  return await parseResponse(client.webauthn.settings.rp.$get(undefined, options))
}
...
export async function putWebauthnSettingsRp(
  ...
  return await parseResponse(client.webauthn.settings.rp.$put(args, options))
}
...
export async function getWebauthnAuthenticators(options?: ClientRequestOptions) {
  return await parseResponse(client.webauthn.authenticators.$get(undefined, options))
}
