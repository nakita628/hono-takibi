...
export async function postEncodingTest(
  ...
  return await parseResponse(client['encoding-test'].$post(args, options))
}
...
export async function getContentNegotiation(
  ...
  return await parseResponse(client['content-negotiation'].$get(args, options))
}
...
export async function postBinaryVariations(
  ...
  return await parseResponse(client['binary-variations'].$post(args, options))
}
...
export async function getStreaming(options?: ClientRequestOptions) {
  return await parseResponse(client.streaming.$get(undefined, options))
}
...
export async function postStreaming(
  ...
  return await parseResponse(client.streaming.$post(args, options))
}
...
export async function postUrlEncodedComplex(
  ...
  return await parseResponse(client['url-encoded-complex'].$post(args, options))
}
...
export async function getResponseEncoding(options?: ClientRequestOptions) {
  return await parseResponse(client['response-encoding'].$get(undefined, options))
}
...
export async function postSchemaEncoding(
  ...
  return await parseResponse(client['schema-encoding'].$post(args, options))
}
