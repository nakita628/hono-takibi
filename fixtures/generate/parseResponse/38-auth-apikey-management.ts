...
export async function getApiKeys(
  ...
  return await parseResponse(client['api-keys'].$get(args, options))
}
...
export async function postApiKeys(
  ...
  return await parseResponse(client['api-keys'].$post(args, options))
}
...
export async function getApiKeysKeyId(
  ...
  return await parseResponse(client['api-keys'][':keyId'].$get(args, options))
}
...
export async function deleteApiKeysKeyId(
  ...
  return await parseResponse(client['api-keys'][':keyId'].$delete(args, options))
}
...
export async function patchApiKeysKeyId(
  ...
  return await parseResponse(client['api-keys'][':keyId'].$patch(args, options))
}
...
export async function postApiKeysKeyIdRevoke(
  ...
  return await parseResponse(client['api-keys'][':keyId'].revoke.$post(args, options))
}
...
export async function postApiKeysKeyIdRotate(
  ...
  return await parseResponse(client['api-keys'][':keyId'].rotate.$post(args, options))
}
...
export async function getApiKeysKeyIdUsage(
  ...
  return await parseResponse(client['api-keys'][':keyId'].usage.$get(args, options))
}
...
export async function getApiKeysKeyIdRateLimitCurrent(
  ...
  return await parseResponse(client['api-keys'][':keyId']['rate-limit'].current.$get(args, options))
}
...
export async function postApiKeysVerify(
  ...
  return await parseResponse(client['api-keys'].verify.$post(args, options))
}
...
export async function getScopes(options?: ClientRequestOptions) {
  return await parseResponse(client.scopes.$get(undefined, options))
}
