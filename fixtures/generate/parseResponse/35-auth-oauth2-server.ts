...
export async function getOauthAuthorize(
  ...
  return await parseResponse(client.oauth.authorize.$get(args, options))
}
...
export async function postOauthToken(
  ...
  return await parseResponse(client.oauth.token.$post(args, options))
}
...
export async function postOauthRevoke(
  ...
  return await parseResponse(client.oauth.revoke.$post(args, options))
}
...
export async function postOauthIntrospect(
  ...
  return await parseResponse(client.oauth.introspect.$post(args, options))
}
...
export async function postOauthDeviceCode(
  ...
  return await parseResponse(client.oauth.device.code.$post(args, options))
}
...
export async function getOauthUserinfo(options?: ClientRequestOptions) {
  return await parseResponse(client.oauth.userinfo.$get(undefined, options))
}
...
export async function getWellKnownOpenidConfiguration(options?: ClientRequestOptions) {
  return await parseResponse(client['.well-known']['openid-configuration'].$get(undefined, options))
}
...
export async function getWellKnownJwksJson(options?: ClientRequestOptions) {
  return await parseResponse(client['.well-known']['jwks.json'].$get(undefined, options))
}
...
export async function getOauthClients(options?: ClientRequestOptions) {
  return await parseResponse(client.oauth.clients.$get(undefined, options))
}
...
export async function postOauthClients(
  ...
  return await parseResponse(client.oauth.clients.$post(args, options))
}
...
export async function getOauthClientsClientId(
  ...
  return await parseResponse(client.oauth.clients[':clientId'].$get(args, options))
}
...
export async function putOauthClientsClientId(
  ...
  return await parseResponse(client.oauth.clients[':clientId'].$put(args, options))
}
...
export async function deleteOauthClientsClientId(
  ...
  return await parseResponse(client.oauth.clients[':clientId'].$delete(args, options))
}
...
export async function postOauthClientsClientIdSecret(
  ...
  return await parseResponse(client.oauth.clients[':clientId'].secret.$post(args, options))
}
...
export async function getOauthConsents(options?: ClientRequestOptions) {
  return await parseResponse(client.oauth.consents.$get(undefined, options))
}
...
export async function deleteOauthConsentsClientId(
  ...
  return await parseResponse(client.oauth.consents[':clientId'].$delete(args, options))
}
