...
export async function getSingleAuth(options?: ClientRequestOptions) {
  return await parseResponse(client['single-auth'].$get(undefined, options))
}
...
export async function getAnyAuth(options?: ClientRequestOptions) {
  return await parseResponse(client['any-auth'].$get(undefined, options))
}
...
export async function getAllAuth(options?: ClientRequestOptions) {
  return await parseResponse(client['all-auth'].$get(undefined, options))
}
...
export async function getComplexAuth(options?: ClientRequestOptions) {
  return await parseResponse(client['complex-auth'].$get(undefined, options))
}
...
export async function getScopedOauth(options?: ClientRequestOptions) {
  return await parseResponse(client['scoped-oauth'].$get(undefined, options))
}
...
export async function getMixedLevelSecurity(options?: ClientRequestOptions) {
  return await parseResponse(client['mixed-level-security'].$get(undefined, options))
}
...
export async function putMixedLevelSecurity(options?: ClientRequestOptions) {
  return await parseResponse(client['mixed-level-security'].$put(undefined, options))
}
...
export async function postMixedLevelSecurity(options?: ClientRequestOptions) {
  return await parseResponse(client['mixed-level-security'].$post(undefined, options))
}
...
export async function deleteMixedLevelSecurity(options?: ClientRequestOptions) {
  return await parseResponse(client['mixed-level-security'].$delete(undefined, options))
}
...
export async function getOverrideGlobal(options?: ClientRequestOptions) {
  return await parseResponse(client['override-global'].$get(undefined, options))
}
...
export async function getOptionalEnhanced(options?: ClientRequestOptions) {
  return await parseResponse(client['optional-enhanced'].$get(undefined, options))
}
...
export async function getMultiTenant(options?: ClientRequestOptions) {
  return await parseResponse(client['multi-tenant'].$get(undefined, options))
}
