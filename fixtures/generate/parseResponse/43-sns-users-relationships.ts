...
export async function getUsersByUsernameUsername(
  ...
  return await parseResponse(client.users.by.username[':username'].$get(args, options))
}
...
export async function getUsersSearch(
  ...
  return await parseResponse(client.users.search.$get(args, options))
}
...
export async function getUsersLookup(
  ...
  return await parseResponse(client.users.lookup.$get(args, options))
}
...
export async function patchMe(
  ...
  return await parseResponse(client.me.$patch(args, options))
}
...
export async function postMeAvatar(
  ...
  return await parseResponse(client.me.avatar.$post(args, options))
}
...
export async function deleteMeAvatar(options?: ClientRequestOptions) {
  return await parseResponse(client.me.avatar.$delete(undefined, options))
}
...
export async function postMeBanner(
  ...
  return await parseResponse(client.me.banner.$post(args, options))
}
...
export async function deleteMeBanner(options?: ClientRequestOptions) {
  return await parseResponse(client.me.banner.$delete(undefined, options))
}
...
export async function postUsersUserIdFollow(
  ...
  return await parseResponse(client.users[':userId'].follow.$post(args, options))
}
...
export async function deleteUsersUserIdFollow(
  ...
  return await parseResponse(client.users[':userId'].follow.$delete(args, options))
}
...
export async function getUsersUserIdFollowers(
  ...
  return await parseResponse(client.users[':userId'].followers.$get(args, options))
}
...
export async function getUsersUserIdFollowing(
  ...
  return await parseResponse(client.users[':userId'].following.$get(args, options))
}
...
export async function postUsersUserIdFollowersRemove(
  ...
  return await parseResponse(client.users[':userId'].followers.remove.$post(args, options))
}
...
export async function getRelationships(
  ...
  return await parseResponse(client.relationships.$get(args, options))
}
...
export async function getFollowRequests(
  ...
  return await parseResponse(client['follow-requests'].$get(args, options))
}
...
export async function postFollowRequestsUserIdAccept(
  ...
  return await parseResponse(client['follow-requests'][':userId'].accept.$post(args, options))
}
...
export async function postFollowRequestsUserIdReject(
  ...
  return await parseResponse(client['follow-requests'][':userId'].reject.$post(args, options))
}
...
export async function postUsersUserIdBlock(
  ...
  return await parseResponse(client.users[':userId'].block.$post(args, options))
}
...
export async function deleteUsersUserIdBlock(
  ...
  return await parseResponse(client.users[':userId'].block.$delete(args, options))
}
...
export async function postUsersUserIdMute(
  ...
  return await parseResponse(client.users[':userId'].mute.$post(args, options))
}
...
export async function deleteUsersUserIdMute(
  ...
  return await parseResponse(client.users[':userId'].mute.$delete(args, options))
}
...
export async function getBlocks(
  ...
  return await parseResponse(client.blocks.$get(args, options))
}
...
export async function getMutes(
  ...
  return await parseResponse(client.mutes.$get(args, options))
}
...
export async function getLists(options?: ClientRequestOptions) {
  return await parseResponse(client.lists.$get(undefined, options))
}
...
export async function postLists(
  ...
  return await parseResponse(client.lists.$post(args, options))
}
...
export async function getListsListId(
  ...
  return await parseResponse(client.lists[':listId'].$get(args, options))
}
...
export async function putListsListId(
  ...
  return await parseResponse(client.lists[':listId'].$put(args, options))
}
...
export async function deleteListsListId(
  ...
  return await parseResponse(client.lists[':listId'].$delete(args, options))
}
...
export async function getListsListIdMembers(
  ...
  return await parseResponse(client.lists[':listId'].members.$get(args, options))
}
...
export async function postListsListIdMembers(
  ...
  return await parseResponse(client.lists[':listId'].members.$post(args, options))
}
...
export async function deleteListsListIdMembersUserId(
  ...
  return await parseResponse(client.lists[':listId'].members[':userId'].$delete(args, options))
}
...
export async function getListsListIdTimeline(
  ...
  return await parseResponse(client.lists[':listId'].timeline.$get(args, options))
}
...
export async function getUsersUserIdLists(
  ...
  return await parseResponse(client.users[':userId'].lists.$get(args, options))
}
