...
export async function getSocialAuthorizeProvider(
  ...
  return await parseResponse(client.social.authorize[':provider'].$get(args, options))
}
...
export async function getSocialCallbackProvider(
  ...
  return await parseResponse(client.social.callback[':provider'].$get(args, options))
}
...
export async function postSocialToken(
  ...
  return await parseResponse(client.social.token.$post(args, options))
}
...
export async function postSocialTokenNative(
  ...
  return await parseResponse(client.social.token.native.$post(args, options))
}
...
export async function getProviders(options?: ClientRequestOptions) {
  return await parseResponse(client.providers.$get(undefined, options))
}
...
export async function getProvidersAdmin(options?: ClientRequestOptions) {
  return await parseResponse(client.providers.admin.$get(undefined, options))
}
...
export async function postProvidersAdmin(
  ...
  return await parseResponse(client.providers.admin.$post(args, options))
}
...
export async function getProvidersProviderId(
  ...
  return await parseResponse(client.providers[':providerId'].$get(args, options))
}
...
export async function putProvidersProviderId(
  ...
  return await parseResponse(client.providers[':providerId'].$put(args, options))
}
...
export async function deleteProvidersProviderId(
  ...
  return await parseResponse(client.providers[':providerId'].$delete(args, options))
}
...
export async function postProvidersProviderIdTest(
  ...
  return await parseResponse(client.providers[':providerId'].test.$post(args, options))
}
...
export async function getAccountLinked(options?: ClientRequestOptions) {
  return await parseResponse(client.account.linked.$get(undefined, options))
}
...
export async function postAccountLinkProvider(
  ...
  return await parseResponse(client.account.link[':provider'].$post(args, options))
}
...
export async function deleteAccountLinkProvider(
  ...
  return await parseResponse(client.account.link[':provider'].$delete(args, options))
}
...
export async function getEnterpriseSso(options?: ClientRequestOptions) {
  return await parseResponse(client.enterprise.sso.$get(undefined, options))
}
...
export async function postEnterpriseSso(
  ...
  return await parseResponse(client.enterprise.sso.$post(args, options))
}
...
export async function getEnterpriseSsoConfigId(
  ...
  return await parseResponse(client.enterprise.sso[':configId'].$get(args, options))
}
...
export async function putEnterpriseSsoConfigId(
  ...
  return await parseResponse(client.enterprise.sso[':configId'].$put(args, options))
}
...
export async function deleteEnterpriseSsoConfigId(
  ...
  return await parseResponse(client.enterprise.sso[':configId'].$delete(args, options))
}
...
export async function getEnterpriseSsoDomainLookup(
  ...
  return await parseResponse(client.enterprise.sso['domain-lookup'].$get(args, options))
}
...
export async function getEnterpriseSsoConfigIdMetadata(
  ...
  return await parseResponse(client.enterprise.sso[':configId'].metadata.$get(args, options))
}
