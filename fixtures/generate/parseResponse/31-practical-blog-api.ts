...
export async function putPostsPostId(
  ...
  return await parseResponse(client.posts[':postId'].$put(args, options))
}
...
export async function getPostsSlugSlug(
  ...
  return await parseResponse(client.posts.slug[':slug'].$get(args, options))
}
...
export async function postPostsPostIdPublish(
  ...
  return await parseResponse(client.posts[':postId'].publish.$post(args, options))
}
...
export async function postPostsPostIdUnpublish(
  ...
  return await parseResponse(client.posts[':postId'].unpublish.$post(args, options))
}
...
export async function getPostsPostIdComments(
  ...
  return await parseResponse(client.posts[':postId'].comments.$get(args, options))
}
...
export async function postPostsPostIdComments(
  ...
  return await parseResponse(client.posts[':postId'].comments.$post(args, options))
}
...
export async function deleteCommentsCommentId(
  ...
  return await parseResponse(client.comments[':commentId'].$delete(args, options))
}
...
export async function postCommentsCommentIdApprove(
  ...
  return await parseResponse(client.comments[':commentId'].approve.$post(args, options))
}
...
export async function postCategories(
  ...
  return await parseResponse(client.categories.$post(args, options))
}
...
export async function getCategoriesCategoryId(
  ...
  return await parseResponse(client.categories[':categoryId'].$get(args, options))
}
...
export async function putCategoriesCategoryId(
  ...
  return await parseResponse(client.categories[':categoryId'].$put(args, options))
}
...
export async function deleteCategoriesCategoryId(
  ...
  return await parseResponse(client.categories[':categoryId'].$delete(args, options))
}
...
export async function getTags(
  ...
  return await parseResponse(client.tags.$get(args, options))
}
...
export async function getMedia(
  ...
  return await parseResponse(client.media.$get(args, options))
}
...
export async function postMedia(
  ...
  return await parseResponse(client.media.$post(args, options))
}
...
export async function putMediaMediaId(
  ...
  return await parseResponse(client.media[':mediaId'].$put(args, options))
}
...
export async function deleteMediaMediaId(
  ...
  return await parseResponse(client.media[':mediaId'].$delete(args, options))
}
...
export async function getAuthors(options?: ClientRequestOptions) {
  return await parseResponse(client.authors.$get(undefined, options))
}
...
export async function getAuthorsAuthorId(
  ...
  return await parseResponse(client.authors[':authorId'].$get(args, options))
}
