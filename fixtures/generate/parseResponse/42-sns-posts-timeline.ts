...
export async function deletePostsPostId(
  ...
  return await parseResponse(client.posts[':postId'].$delete(args, options))
}
...
export async function getPostsPostIdThread(
  ...
  return await parseResponse(client.posts[':postId'].thread.$get(args, options))
}
...
export async function getPostsPostIdContext(
  ...
  return await parseResponse(client.posts[':postId'].context.$get(args, options))
}
...
export async function getTimelineHome(
  ...
  return await parseResponse(client.timeline.home.$get(args, options))
}
...
export async function getTimelineForYou(
  ...
  return await parseResponse(client.timeline['for-you'].$get(args, options))
}
...
export async function getTimelineUserUserId(
  ...
  return await parseResponse(client.timeline.user[':userId'].$get(args, options))
}
...
export async function getTimelineHashtagHashtag(
  ...
  return await parseResponse(client.timeline.hashtag[':hashtag'].$get(args, options))
}
...
export async function postPostsPostIdLike(
  ...
  return await parseResponse(client.posts[':postId'].like.$post(args, options))
}
...
export async function deletePostsPostIdLike(
  ...
  return await parseResponse(client.posts[':postId'].like.$delete(args, options))
}
...
export async function postPostsPostIdRepost(
  ...
  return await parseResponse(client.posts[':postId'].repost.$post(args, options))
}
...
export async function deletePostsPostIdRepost(
  ...
  return await parseResponse(client.posts[':postId'].repost.$delete(args, options))
}
...
export async function postPostsPostIdQuote(
  ...
  return await parseResponse(client.posts[':postId'].quote.$post(args, options))
}
...
export async function postPostsPostIdBookmark(
  ...
  return await parseResponse(client.posts[':postId'].bookmark.$post(args, options))
}
...
export async function deletePostsPostIdBookmark(
  ...
  return await parseResponse(client.posts[':postId'].bookmark.$delete(args, options))
}
...
export async function getBookmarks(
  ...
  return await parseResponse(client.bookmarks.$get(args, options))
}
...
export async function getPostsPostIdLikes(
  ...
  return await parseResponse(client.posts[':postId'].likes.$get(args, options))
}
...
export async function getPostsPostIdReposts(
  ...
  return await parseResponse(client.posts[':postId'].reposts.$get(args, options))
}
...
export async function getPostsPostIdQuotes(
  ...
  return await parseResponse(client.posts[':postId'].quotes.$get(args, options))
}
...
export async function getPostsPostIdReplies(
  ...
  return await parseResponse(client.posts[':postId'].replies.$get(args, options))
}
...
export async function postPostsPostIdReplies(
  ...
  return await parseResponse(client.posts[':postId'].replies.$post(args, options))
}
...
export async function postMediaUpload(
  ...
  return await parseResponse(client.media.upload.$post(args, options))
}
...
export async function getMediaMediaId(
  ...
  return await parseResponse(client.media[':mediaId'].$get(args, options))
}
...
export async function patchMediaMediaId(
  ...
  return await parseResponse(client.media[':mediaId'].$patch(args, options))
}
