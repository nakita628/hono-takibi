...
export async function postProductsProductIdImages(
  ...
  return await parseResponse(client.products[':productId'].images.$post(args, options))
}
...
export async function getCart(options?: ClientRequestOptions) {
  return await parseResponse(client.cart.$get(undefined, options))
}
...
export async function deleteCart(options?: ClientRequestOptions) {
  return await parseResponse(client.cart.$delete(undefined, options))
}
...
export async function postCartItems(
  ...
  return await parseResponse(client.cart.items.$post(args, options))
}
...
export async function putCartItemsItemId(
  ...
  return await parseResponse(client.cart.items[':itemId'].$put(args, options))
}
...
export async function deleteCartItemsItemId(
  ...
  return await parseResponse(client.cart.items[':itemId'].$delete(args, options))
}
...
export async function postOrdersOrderIdCancel(
  ...
  return await parseResponse(client.orders[':orderId'].cancel.$post(args, options))
}
...
export async function getInventoryProductId(
  ...
  return await parseResponse(client.inventory[':productId'].$get(args, options))
}
...
export async function putInventoryProductId(
  ...
  return await parseResponse(client.inventory[':productId'].$put(args, options))
}
