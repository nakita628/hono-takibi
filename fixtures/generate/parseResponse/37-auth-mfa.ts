...
export async function getMfaStatus(options?: ClientRequestOptions) {
  return await parseResponse(client.mfa.status.$get(undefined, options))
}
...
export async function getMfaMethods(options?: ClientRequestOptions) {
  return await parseResponse(client.mfa.methods.$get(undefined, options))
}
...
export async function putMfaPreferred(
  ...
  return await parseResponse(client.mfa.preferred.$put(args, options))
}
...
export async function postMfaTotpSetup(
  ...
  return await parseResponse(client.mfa.totp.setup.$post(args, options))
}
...
export async function postMfaTotpVerify(
  ...
  return await parseResponse(client.mfa.totp.verify.$post(args, options))
}
...
export async function deleteMfaTotp(
  ...
  return await parseResponse(client.mfa.totp.$delete(args, options))
}
...
export async function postMfaSmsSetup(
  ...
  return await parseResponse(client.mfa.sms.setup.$post(args, options))
}
...
export async function postMfaSmsVerify(
  ...
  return await parseResponse(client.mfa.sms.verify.$post(args, options))
}
...
export async function deleteMfaSmsMethodId(
  ...
  return await parseResponse(client.mfa.sms[':methodId'].$delete(args, options))
}
...
export async function postMfaEmailSetup(
  ...
  return await parseResponse(client.mfa.email.setup.$post(args, options))
}
...
export async function postMfaEmailVerify(
  ...
  return await parseResponse(client.mfa.email.verify.$post(args, options))
}
...
export async function postMfaWebauthnRegisterOptions(
  ...
  return await parseResponse(client.mfa.webauthn.register.options.$post(args, options))
}
...
export async function postMfaWebauthnRegisterVerify(
  ...
  return await parseResponse(client.mfa.webauthn.register.verify.$post(args, options))
}
...
export async function getMfaWebauthnCredentials(options?: ClientRequestOptions) {
  return await parseResponse(client.mfa.webauthn.credentials.$get(undefined, options))
}
...
export async function deleteMfaWebauthnCredentialsCredentialId(
  ...
  return await parseResponse(
    client.mfa.webauthn.credentials[':credentialId'].$delete(args, options),
  )
}
...
export async function patchMfaWebauthnCredentialsCredentialId(
  ...
  return await parseResponse(client.mfa.webauthn.credentials[':credentialId'].$patch(args, options))
}
...
export async function postMfaBackupCodesGenerate(
  ...
  return await parseResponse(client.mfa['backup-codes'].generate.$post(args, options))
}
...
export async function getMfaBackupCodesStatus(options?: ClientRequestOptions) {
  return await parseResponse(client.mfa['backup-codes'].status.$get(undefined, options))
}
...
export async function postMfaChallenge(
  ...
  return await parseResponse(client.mfa.challenge.$post(args, options))
}
...
export async function postMfaChallengeSend(
  ...
  return await parseResponse(client.mfa.challenge.send.$post(args, options))
}
...
export async function postMfaVerify(
  ...
  return await parseResponse(client.mfa.verify.$post(args, options))
}
...
export async function postMfaWebauthnAuthenticateOptions(
  ...
  return await parseResponse(client.mfa.webauthn.authenticate.options.$post(args, options))
}
...
export async function postMfaRecovery(
  ...
  return await parseResponse(client.mfa.recovery.$post(args, options))
}
...
export async function postMfaRecoveryVerify(
  ...
  return await parseResponse(client.mfa.recovery.verify.$post(args, options))
}
