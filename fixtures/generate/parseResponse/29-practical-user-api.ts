...
export async function postAuthRegister(
  ...
  return await parseResponse(client.auth.register.$post(args, options))
}
...
export async function postAuthLogin(
  ...
  return await parseResponse(client.auth.login.$post(args, options))
}
...
export async function postAuthRefresh(
  ...
  return await parseResponse(client.auth.refresh.$post(args, options))
}
...
export async function postAuthLogout(options?: ClientRequestOptions) {
  return await parseResponse(client.auth.logout.$post(undefined, options))
}
...
export async function postAuthPasswordForgot(
  ...
  return await parseResponse(client.auth.password.forgot.$post(args, options))
}
...
export async function postAuthPasswordReset(
  ...
  return await parseResponse(client.auth.password.reset.$post(args, options))
}
...
export async function putUsersMePassword(
  ...
  return await parseResponse(client.users.me.password.$put(args, options))
}
...
export async function putUsersMeAvatar(
  ...
  return await parseResponse(client.users.me.avatar.$put(args, options))
}
...
export async function deleteUsersMeAvatar(options?: ClientRequestOptions) {
  return await parseResponse(client.users.me.avatar.$delete(undefined, options))
}
