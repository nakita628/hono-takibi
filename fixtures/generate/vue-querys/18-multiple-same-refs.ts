...
/**
 * Returns Vue Query mutation options for PUT /documents/{documentId}
 *
 * Use with useMutation, setMutationDefaults, or isMutating.
 */
...
/**
 * Returns Vue Query mutation options for POST /documents/{documentId}/share
 *
 * Use with useMutation, setMutationDefaults, or isMutating.
 */
...
/**
 * Returns Vue Query mutation options for POST /compare
 *
 * Use with useMutation, setMutationDefaults, or isMutating.
 */
...
/**
 * Returns Vue Query mutation options for POST /workflows
 *
 * Use with useMutation, setMutationDefaults, or isMutating.
 */
