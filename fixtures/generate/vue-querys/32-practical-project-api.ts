...
export function getGetProjectsProjectIdQueryKey(
  ...
  return ['projects', 'GET', '/projects/:projectId', unref(args)] as const
}
...
export function getGetProjectsProjectIdMembersQueryKey(
  ...
  return ['projects', 'GET', '/projects/:projectId/members', unref(args)] as const
}
...
export function getGetProjectsProjectIdTasksQueryKey(
  ...
  return ['projects', 'GET', '/projects/:projectId/tasks', unref(args)] as const
}
...
export function getGetTasksTaskIdQueryKey(
  ...
  return ['tasks', 'GET', '/tasks/:taskId', unref(args)] as const
}
...
export function getGetTasksTaskIdCommentsQueryKey(
  ...
  return ['tasks', 'GET', '/tasks/:taskId/comments', unref(args)] as const
}
...
export function getGetTasksTaskIdTimeEntriesQueryKey(
  ...
  return ['tasks', 'GET', '/tasks/:taskId/time-entries', unref(args)] as const
}
...
export function getGetProjectsProjectIdMilestonesQueryKey(
  ...
  return ['projects', 'GET', '/projects/:projectId/milestones', unref(args)] as const
}
