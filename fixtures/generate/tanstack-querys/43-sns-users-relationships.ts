...
export function useGetUsersByUsernameUsername(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({
    ...getGetUsersByUsernameUsernameQueryOptions(args, clientOptions),
    ...queryOptions,
  })
}
...
export function useGetUsersSearch(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetUsersSearchQueryOptions(args, clientOptions), ...queryOptions })
}
...
export function useGetUsersLookup(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetUsersLookupQueryOptions(args, clientOptions), ...queryOptions })
}
...
export function usePatchMe(options?: {
  mutation?: {
    onSuccess?: (
      data: Awaited<ReturnType<typeof parseResponse<Awaited<ReturnType<typeof client.me.$patch>>>>>,
...
export function useGetUsersUserIdFollowers(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({
    ...getGetUsersUserIdFollowersQueryOptions(args, clientOptions),
    ...queryOptions,
  })
}
...
export function useGetUsersUserIdFollowing(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({
    ...getGetUsersUserIdFollowingQueryOptions(args, clientOptions),
    ...queryOptions,
  })
}
      ...
      data:
        | Awaited<
            ReturnType<
              typeof parseResponse<
                Awaited<
                  ReturnType<(typeof client.users)[':userId']['followers']['remove']['$post']>
                >
              >
            >
          >
...
export function useGetRelationships(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetRelationshipsQueryOptions(args, clientOptions), ...queryOptions })
}
...
export function useGetFollowRequests(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetFollowRequestsQueryOptions(args, clientOptions), ...queryOptions })
}
      ...
      data:
        | Awaited<
            ReturnType<
              typeof parseResponse<
                Awaited<
                  ReturnType<(typeof client)['follow-requests'][':userId']['accept']['$post']>
                >
              >
            >
          >
      ...
      data:
        | Awaited<
            ReturnType<
              typeof parseResponse<
                Awaited<
                  ReturnType<(typeof client)['follow-requests'][':userId']['reject']['$post']>
                >
              >
            >
          >
...
export function useGetBlocks(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetBlocksQueryOptions(args, clientOptions), ...queryOptions })
}
...
export function useGetMutes(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetMutesQueryOptions(args, clientOptions), ...queryOptions })
}
...
export function useGetLists(options?: {
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetListsQueryOptions(clientOptions), ...queryOptions })
}
...
export function usePostLists(options?: {
  mutation?: {
    onSuccess?: (
      data: Awaited<
        ReturnType<typeof parseResponse<Awaited<ReturnType<typeof client.lists.$post>>>>
      >,
...
export function useGetListsListId(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetListsListIdQueryOptions(args, clientOptions), ...queryOptions })
}
...
export function useGetListsListIdMembers(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetListsListIdMembersQueryOptions(args, clientOptions), ...queryOptions })
}
...
export function useGetListsListIdTimeline(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({
    ...getGetListsListIdTimelineQueryOptions(args, clientOptions),
    ...queryOptions,
  })
}
...
export function useGetUsersUserIdLists(
  ...
  const { query: queryOptions, client: clientOptions } = options ?? {}
  return useQuery({ ...getGetUsersUserIdListsQueryOptions(args, clientOptions), ...queryOptions })
}
