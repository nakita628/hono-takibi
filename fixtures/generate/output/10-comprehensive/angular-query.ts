...
export function injectProducts<TData = Awaited<ReturnType<typeof getProducts>>, TError = unknown>(
  args: () => InferRequestType<typeof client.products.$get>,
  options?: () => {
...
export function injectOrders<TData = Awaited<ReturnType<typeof getOrders>>, TError = unknown>(
  args: () => InferRequestType<typeof client.orders.$get>,
  options?: () => {
