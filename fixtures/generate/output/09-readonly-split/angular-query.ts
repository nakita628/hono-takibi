...
export function injectPostsId<TData = Awaited<ReturnType<typeof getPostsId>>, TError = unknown>(
  args: () => InferRequestType<(typeof client.posts)[':id']['$get']>,
  options?: () => {
...
export function injectPutPostsId<TError = unknown>(
  options?: () => {
    mutation?: CreateMutationOptions<
...
export function injectDeletePostsId<TError = unknown>(
  options?: () => {
    mutation?: CreateMutationOptions<
...
export function injectPostsIdComments<
...
export function injectPostPostsIdComments<TError = unknown>(
  options?: () => {
    mutation?: CreateMutationOptions<
...
export function injectTags<TData = Awaited<ReturnType<typeof getTags>>, TError = unknown>(
  options?: () => {
