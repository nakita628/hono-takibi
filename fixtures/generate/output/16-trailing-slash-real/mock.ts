...
const getApiReverseGeocodeIndexRouteHandler: RouteHandler<
  typeof getApiReverseGeocodeIndexRoute
> = async (c) => {
  return c.json(
    {
...
const postApiV2PublicBookingAccountRegisterOauthIndexRouteHandler: RouteHandler<
  typeof postApiV2PublicBookingAccountRegisterOauthIndexRoute
> = async (c) => {
  return c.json(
    {
...
export const api = app
  ...
  .openapi(
    postApiV2PublicBookingAccountRegisterOauthIndexRoute,
    postApiV2PublicBookingAccountRegisterOauthIndexRouteHandler,
  )
  .openapi(
    postApiV2PublicBookingAccountRegisterEmailRoute,
    postApiV2PublicBookingAccountRegisterEmailRouteHandler,
  )
