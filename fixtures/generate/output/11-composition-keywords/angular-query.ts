...
export function injectNotRef<TData = Awaited<ReturnType<typeof getNotRef>>, TError = unknown>(
  options?: () => {
...
export function injectNotEnum<TData = Awaited<ReturnType<typeof getNotEnum>>, TError = unknown>(
  options?: () => {
...
export function injectNotConst<TData = Awaited<ReturnType<typeof getNotConst>>, TError = unknown>(
  options?: () => {
...
export function injectAnyOfRef<TData = Awaited<ReturnType<typeof getAnyOfRef>>, TError = unknown>(
  options?: () => {
