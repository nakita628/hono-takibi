...
type CircularRefsTreeNodeType = {
  readonly id: number
  readonly value: string
  readonly children?: readonly CircularRefsTreeNodeType[]
}
...
type CircularRefsNodeAType = {
  readonly id: number
  readonly ref?: z.infer<typeof CircularRefsNodeBSchema>
}
...
type CircularRefsNodeBType = {
  readonly id: number
  readonly ref?: z.infer<typeof CircularRefsNodeCSchema>
}
...
type CircularRefsNodeCType = {
  readonly id: number
  readonly ref?: z.infer<typeof CircularRefsNodeASchema>
}

type ComplexSchemasLiteralExprType = {
...
type ComplexSchemasUnaryExprType = {
  readonly type: 'unary'
  readonly operator: '-' | '!'
  readonly operand: z.infer<typeof ComplexSchemasExpressionSchema>
}

type ComplexSchemasBinaryExprType = {
  readonly type: 'binary'
  readonly operator: '+' | '-' | '*' | '/'
  readonly left: z.infer<typeof ComplexSchemasExpressionSchema>
  readonly right: z.infer<typeof ComplexSchemasExpressionSchema>
}
...
type ComplexSchemasCategoryType = {
  ...
  readonly parent?: ComplexSchemasCategoryType
  readonly children?: readonly ComplexSchemasCategoryType[]
}
...
export const AllExportsUserListSchema = z
  .array(AllExportsUserSchema)
  .readonly()
  .openapi('AllExportsUserList')
  ...
  .lazy(() =>
    z
      .object({
        id: z.int(),
        value: z.string(),
        children: z.array(CircularRefsTreeNodeSchema).readonly().exactOptional(),
      })
      .readonly()
...
export const SchemaEdgeCasesNullableFieldsSchema = z
  .object({
    ...
    tags: z.array(z.string()).readonly().nullable().exactOptional(),
  })
  .readonly()
...
export const SchemaEdgeCasesComposedObjectSchema = SchemaEdgeCasesBaseSchema.and(
  ...
  .and(z.object({ extra: z.boolean().exactOptional() }).readonly())
...
export const CrudRefsPostSchema = z
  .object({
    ...
    tags: z.array(CrudRefsTagSchema).readonly().exactOptional(),
...
export const ComprehensiveOrderSchema = z
  .object({
    ...
    items: z.array(ComprehensiveOrderItemSchema).readonly(),
...
export const CompositionKeywordsSearchFilterSchema = z
  .union([
    z
      .object({ keyword: z.string() })
      .readonly()
      .openapi({ required: ['keyword'] }),
    z
      .object({ category: z.int() })
      .readonly()
      .openapi({ required: ['category'] }),
  ])
...
export const CompositionKeywordsEmployeeSchema = CompositionKeywordsPersonSchema.and(
  ...
  .and(z.object({ startDate: z.iso.date().exactOptional() }).readonly())
  ...
  .lazy(() =>
    z
      .object({
        ...
        children: z.array(ComplexSchemasCategorySchema).readonly().exactOptional(),
      })
      .readonly()
      .openapi({ required: ['id', 'name'] }),
  )
...
export const VendorExtensionsCustomFormSchema = z
  .object({
    ...
    config: z.object({ name: z.string().exactOptional() }).readonly().readonly(),
...
export const VendorExtensionsMessageFormSchema = z
  .object({
    ...
    tags: z
      ...
      .readonly(),
    pin: z.array(z.int()).length(4, { error: 'pin must contain exactly 4 digits' }).readonly(),
...
export const VendorExtensionsConditionalSchema = z
  ...
  .superRefine((o, ctx) => {
    ...
    if (ifOk) {
      ...
      const Branch = z.object({}).readonly().openapi({ required: [] })
      if (!Branch) {
        return
      }
      const result = Branch.safeParse(o)
...
export const PaginationItemsPageSchema = z
  .object({
    items: z.array(PaginationItemSchema).readonly(),
...
export const SecuritySchemesBasicAuthSecurityScheme = { type: 'http', scheme: 'basic' } as const
  ...
  responses: {
    200: {
      ...
      content: {
        'application/json': {
          schema: z
            .object({ items: z.array(ParametersMergeItemSchema).readonly(), total: z.int() })
            .readonly()
  ...
  responses: {
    200: {
      ...
      content: {
        'application/json': {
          schema: z
            .object({ posts: z.array(CrudRefsPostSchema).readonly(), total: z.int() })
            .readonly()
...
export const getCrudRefsPostsIdCommentsRoute = createRoute({
  ...
  responses: {
    200: {
      description: 'OK',
      content: { 'application/json': { schema: z.array(CrudRefsCommentSchema).readonly() } },
    },
  },
} as const)
...
export const getCrudRefsTagsRoute = createRoute({
  ...
  responses: {
    200: {
      description: 'OK',
      content: { 'application/json': { schema: z.array(CrudRefsTagSchema).readonly() } },
    },
  },
} as const)
  ...
  responses: {
    200: {
      ...
      content: {
        'application/json': {
          schema: z
            .object({ users: z.array(ComprehensiveUserSchema).readonly(), total: z.int() })
            .readonly()
            .openapi({ required: ['users', 'total'] }),
        },
      },
  ...
  responses: {
    200: {
      ...
      content: {
        'application/json': {
          schema: z
            .object({ products: z.array(ComprehensiveProductSchema).readonly(), total: z.int() })
            .readonly()
...
export const getComprehensiveProductsProductIdReviewsRoute = createRoute({
  ...
  responses: {
    200: {
      description: 'OK',
      content: { 'application/json': { schema: z.array(ComprehensiveReviewSchema).readonly() } },
    },
  },
} as const)
  ...
  responses: {
    200: {
      ...
      content: {
        'application/json': {
          schema: z
            .object({ orders: z.array(ComprehensiveOrderSchema).readonly(), total: z.int() })
            .readonly()
...
export const getComprehensiveCategoriesRoute = createRoute({
  ...
  responses: {
    200: {
      description: 'OK',
      content: { 'application/json': { schema: z.array(ComprehensiveCategorySchema).readonly() } },
    },
  },
} as const)
...
export const getReadonlyRefItemsRoute = createRoute({
  ...
  responses: {
    200: {
      description: 'OK',
      content: { 'application/json': { schema: z.array(ReadonlyRefItemSchema).readonly() } },
    },
