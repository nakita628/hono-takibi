...
export function createTree<TData = Awaited<ReturnType<typeof getTree>>, TError = unknown>(
  options?: () => {
...
export function createGraph<TData = Awaited<ReturnType<typeof getGraph>>, TError = unknown>(
  options?: () => {
