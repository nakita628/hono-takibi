...
export function injectPublic<TData = Awaited<ReturnType<typeof getPublic>>, TError = unknown>(
  options?: () => {
...
export function injectBearerProtected<
...
export function injectApiKeyProtected<
...
export function injectBasicProtected<
...
export function injectOauthProtected<
...
export function injectMultiAuth<TData = Awaited<ReturnType<typeof getMultiAuth>>, TError = unknown>(
  options?: () => {
