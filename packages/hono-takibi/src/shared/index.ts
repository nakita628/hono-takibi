          ...
          run: (output: string) =>
            ((p: string): p is `${string}.ts` => p.endsWith('.ts'))(output)
              ? takibi(openAPI, output, {
                  ...
                  exportSchemas: config.exportSchemas ?? false,
                  exportSchemasTypes: config.exportSchemasTypes ?? false,
                  exportResponses: config.exportResponses ?? false,
                  exportParameters: config.exportParameters ?? false,
                  exportParametersTypes: config.exportParametersTypes ?? false,
                  exportExamples: config.exportExamples ?? false,
                  exportRequestBodies: config.exportRequestBodies ?? false,
                  exportHeaders: config.exportHeaders ?? false,
                  exportHeadersTypes: config.exportHeadersTypes ?? false,
                  exportSecuritySchemes: config.exportSecuritySchemes ?? false,
                  exportLinks: config.exportLinks ?? false,
                  exportCallbacks: config.exportCallbacks ?? false,
                  exportPathItems: config.exportPathItems ?? false,
                  exportMediaTypes: config.exportMediaTypes ?? false,
                  exportMediaTypesTypes: config.exportMediaTypesTypes ?? false,
                })
