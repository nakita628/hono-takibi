...
const generateRouteCodeTestCases: { input: OpenAPIPaths; expected: string }[] = [
  {
    ...
    expected: `export const putPetRoute=createRoute({tags:["pet"],method:'put',path:'/pet',description:'Update an existing pet by Id',security:[{"petstore_auth":["write:pets","read:pets"]}],request:{body:{required:true,content:{'application/json':{schema:Pet,},},},},responses:{200:{description:'Successful operation',content:{'application/json':{schema:Pet,},},},400:{description:'Invalid ID supplied',},404:{description:'Pet not found',},422:{description:'Validation exception',},}})
