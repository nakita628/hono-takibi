...
describe('generateComponentsCode', () => {
  it.concurrent('generateComponentsCode({})', () => {
  ...
  it.concurrent('generateComponentsCode(components)', () => {
    const components: Components = {
      schemas: {
        Product: {
          type: 'object',
