...
`)
  ...
  'zod-openapi': {
    ...
    components: {
      ...
      const parametersIndex = fs.readFileSync(
        path.join(testDir, 'src/parameters/index.ts'),
        'utf-8',
      )
...
`)
  ...
  'zod-openapi': {
    ...
    components: {
      ...
      const rateLimitHeader = fs.readFileSync(
        path.join(testDir, 'src/headers/rateLimit.ts'),
        'utf-8',
      )
