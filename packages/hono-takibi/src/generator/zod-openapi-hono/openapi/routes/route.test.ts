...
describe('route', () => {
  it.concurrent('route Test', () => {
    ...
    const expected = `export const postPostsRoute=createRoute({tags:["Hono"],method:'post',path:'/posts',operationId:'updatePost',responses:{200:{description:'Hono🔥',content:{'application/json':{schema:z.object({message:z.string().optional().openapi({"name":"message","type":"string","example":"Hono🔥"})}).optional().openapi({"name":"root","type":"object","properties":{"message":{"name":"message","type":"string","example":"Hono🔥"}}})}}},}})`
