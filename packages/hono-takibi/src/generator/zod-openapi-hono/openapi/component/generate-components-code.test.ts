...
export type Test = z.infer<typeof TestSchema>`
  ...
  // },
  test('schema name PascalCase export true type not output export false', () => {
    const result = generateComponentsCode(testComponents, {
      schema: { name: 'PascalCase', export: true },
      type: { name: 'PascalCase', export: false },
    })
...
`
  ...
  // },
  test('schema name PascalCase export true type camelCase export true', () => {
    const result = generateComponentsCode(testComponents, {
      schema: { name: 'PascalCase', export: true },
      type: { name: 'camelCase', export: true },
    })
...
`
  ...
  //   type: { name: 'PascalCase', export: true }
  // },
  test('schema name PascalCase export false type PascalCase export true', () => {
    const result = generateComponentsCode(testComponents, {
      schema: { name: 'PascalCase', export: false },
      type: { name: 'PascalCase', export: true },
    })
...
export type Test = z.infer<typeof TestSchema>`
  ...
  //   type: { name: 'PascalCase', export: false }
  // },
  test('schema name PascalCase export false type not output export false', () => {
    const result = generateComponentsCode(testComponents, {
      schema: { name: 'PascalCase', export: false },
      type: { name: 'PascalCase', export: false },
    })
...
`
  ...
  //   type: { name: 'camelCase', export: true }
  // },
  test('schema name PascalCase export false type camelCase export true', () => {
    const result = generateComponentsCode(testComponents, {
      schema: { name: 'PascalCase', export: false },
      type: { name: 'camelCase', export: true },
    })
