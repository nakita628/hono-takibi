...
export const postACRoute=createRoute({method:'post',path:'/A/{C}',operationId:'A',security:[{"A":[]}],callbacks:{"A":ACallback},request:{body:ARequestBody,},responses:{200:AResponse,}})

export const postBCRoute=createRoute({method:'post',path:'/B/{C}',operationId:'B',security:[{"B":[]}],callbacks:{"B":BCallback},request:{body:BRequestBody,},responses:{200:BResponse,}})

export const postCCRoute=createRoute({method:'post',path:'/C/{C}',operationId:'C',security:[{"C":[]}],callbacks:{"C":CCallback},request:{body:CRequestBody,},responses:{200:CResponse,}})`
