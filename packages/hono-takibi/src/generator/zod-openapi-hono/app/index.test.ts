...
describe('app', () => {
  it.concurrent('app Test', () => {
    const result = app(openapi, 'app.ts', undefined)
...
app.doc('/doc',{"openapi":"3.1.0","info":{"title":"HonoTakibi🔥","version":"v1"},"tags":[{"name":"Hono"},{"name":"HonoX"},{"name":"ZodOpenAPIHono"}]}).get('/ui',swaggerUI({url:'/doc'}))}
